...
const Card = ({ data }) => {
  return (
    <div className="p-3 h-max "  >
      <div className="relative flex w-full max-w-[26rem] flex-col rounded-xl dark:bg-[#1e2329]  bg-white bg-clip-border text-gray-700 shadow-lg h-max">
        ...
        <div className="p-6">
          ...
          <p
            ...
            className="block mt-5 overflow-hidden text-ellipsis text-[12px] font-sans h-[36px]  leading-relaxed text-gray-500 antialiased line-clamp-1"
          >
            {data.description}
          </p>
        </div>
