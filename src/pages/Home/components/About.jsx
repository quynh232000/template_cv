    ...
    <>
      <div className="flex lg:flex-row  flex-col-reverse">
        <div className="basis-2/3 dark:text-white pb-5">
          <h1 className="lg:text-5xl text-center lg:text-start text-3xl mt-5 lg:mt-0 font-bold "  data-aos="fade-right">{`I'm Nguyen Van Quynh`}</h1>
          ...
          <p className="mt-5 text-sm text-center lg:text-start text-gray-500" data-aos="fade-up">
            I am passionate about Web development to create user-friendly
